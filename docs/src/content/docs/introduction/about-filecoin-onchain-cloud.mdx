...
- **[Core Concepts](/core-concepts/)** - Deep dive into the architecture and protocols
- **[Get Started](/getting-started/)** - Begin implementing with the Synapse SDK

**Related Topics:**

- [Architecture Overview](/core-concepts/architecture/) - Detailed system design and component interaction
