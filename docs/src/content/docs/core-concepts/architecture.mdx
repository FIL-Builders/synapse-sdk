...
Each service in this architecture is implemented as a Service Contract on the FVM, and the network as a whole behaves like a composable onchain runtime for decentralized data services.
