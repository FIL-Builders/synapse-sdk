...
- **SDK Users**: Focus on the concepts, then jump to [Payment Setup Guide](/synapse-sdk/payments/)
- **Smart Contract Developers**: Study the contract interfaces and operator patterns
- **Protocol Researchers**: Deep dive into the lockup mechanism and security properties
:::
...
**Available Balance**: `account.funds - account.lockupCurrent`

**Streaming Lockup**: `paymentRate × lockupPeriod`
- Example: 3 USDFC/epoch × 2,880 epochs = 8,640 USDFC locked

**Total Lockup**: `streamingLockup + lockupFixed`
- Example: 8,640 + 100 = 8,740 USDFC total locked

**Termination End Epoch**: `lastSettledEpoch + lockupPeriod`
- Provider can settle from locked funds up to this epoch
- Guarantees payment even if client disappears
...
- Study the FilecoinPay contract source code
...
- Review the FilecoinPay contract implementation
:::
